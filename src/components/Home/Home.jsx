...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    if (obj && obj.token) {
      ...
      fetch(
        "https://cvrrcollabnotes.herokuapp.com/api/account/verify?token=" +
          tokenid
      )
        .then((res) => res.json())
        .then((json) => {
  ...
  onSignUp() {
    ...
    fetch("https://cvrrcollabnotes.herokuapp.com/api/account/signup", {
      method: "POST",
      headers: {
  ...
  onSignIn() {
    ...
    fetch("https://cvrrcollabnotes.herokuapp.com/api/account/signin", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  logout() {
    ...
    if (obj && obj.token) {
      ...
      const tokenid = token[0];
      fetch(
        "https://cvrrcollabnotes.herokuapp.com/api/account/logout?token=" +
          tokenid
      )
        .then((res) => res.json())
        .then((json) => {
          ...
          <nav className="navbar navbar-expand-lg">
            ...
            <div className="collapse navbar-collapse">
              <div className="navbar-nav nav-fill w-100">
                <Link
                  className="nav-item nav-link btn-primary btn"
                  style={{ marginRight: "5px" }}
                  to="/group/try"
                >
                  Try<span className="sr-only">(current)</span>
                </Link>
                <Link
                  className="nav-item btn nav-link btn-primary"
                  style={{ marginRight: "5px" }}
                  to="/mynotes"
                >
                  My Notes
